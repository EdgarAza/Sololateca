            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formEditar" action="cProveedores" method="post">
                            ...
                            <input type="text" name="txtInfoPago" class="form-control" required>
                            <label>Condiciones de pago</label>
                            <input type="text" name="txtConPago" class="form-control" required> 
                            <label>Estado</label>
